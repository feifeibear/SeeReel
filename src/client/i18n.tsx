...
const zh = {
  app: {
    ...
    agentPlanClear: "清除",
    adminButton: "Admin",
    adminButtonTitle: "管理员演示配置",
    adminLoginTitle: "管理员登录",
    adminDefaultHint: "默认账号 admin / Fjr123456，请上线后改环境变量密码。",
    adminPasswordPlaceholder: "管理员密码",
    adminLogin: "登录",
    adminTrialTitle: "免费试用 Agent Plan",
    ...
    adminAgentPlanPlaceholder: "粘贴管理员 Agent Plan Key",
    adminSave: "保存",
    adminClear: "清除",
    adminLogout: "退出"
  },
...
const en: Dictionary = {
  app: {
    ...
    adminButton: "Admin",
    adminButtonTitle: "Admin demo settings",
    adminLoginTitle: "Admin login",
    adminDefaultHint: "Default account is admin / Fjr123456. Change the env password before going public.",
    adminPasswordPlaceholder: "Admin password",
    adminLogin: "Login",
    adminTrialTitle: "Free-trial Agent Plan",
    ...
    adminAgentPlanPlaceholder: "Paste admin Agent Plan Key",
    adminSave: "Save",
    adminClear: "Clear",
    adminLogout: "Logout"
  },
