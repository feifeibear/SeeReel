...
- [ ] Run `npm run smoke:libtv-style-stitch` and `npm run smoke:stitch-stale-sync` when canvas stitch UI, stitch playlist selection, stitch freshness sync, Shot-to-Shot video chain behavior, or right-click node creation changes.
